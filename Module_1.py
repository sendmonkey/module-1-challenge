...
print("the number of loans are : " , number_of_loans)
...
print("the sum of loans are : " , sum_of_loans)
...
number_of_loans = len(loan_costs)
sum_of_loans = sum(loan_costs)
print("the average of loans are : " , sum_of_loans/number_of_loans)
...
# YOUR CODE HERE!
if fair_value >= loan.get("loan_price", 500):
    print("The loan is worth buying")
else:
    print("loan is not worth buyuing")
